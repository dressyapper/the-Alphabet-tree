function prestigeButtonText(layer, add) {
...
function achievementStyle(layer, id){
    ...
    if (Object.keys(ach).includes("unlocked")) {
		if (ach.unlocked == true) {style.push({'visibility': 'visibile'})}
		else {style.push({'visibility': 'hidden'})}}
	else {
